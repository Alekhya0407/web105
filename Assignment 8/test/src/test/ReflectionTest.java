...
public class ReflectionTest {
    ...
    public static void main(String args[]) throws ClassNotFoundException {
        ...
        try {
            ...
            Person privateRyan = new Person("Evon" , "9683792678");
        ...
        } catch (InvocationTargetException | NoSuchMethodException | IllegalArgumentException | IllegalAccessException | NoSuchFieldException | SecurityException ex) {
